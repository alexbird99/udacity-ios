...
func greater(_ n1: Int, _ n2: Int) -> Int {
    if (n1 > n2) {
        return n1
    } else {
        return n2
...
func lesser(_ n1: Int, _ n2: Int) -> Int {
    if (n1 > n2) {
        return n2
    } else {
        return n1
...
func median(num1: Int, num2: Int, num3: Int) -> Int {
    ...
    return lesser(greater(num1, num2), greater(num1, num3))
}
...
func beginsWithVowel(_ s: String) -> Bool {
    ...
    if (s == "") {
        ...
        let firstChar = s.characters[s.startIndex]
        return "aeiouAEIOU".contains(String(firstChar))
    }
}
